...
15X Revamp - LXYO WAS HERE DISCORD : lxyodev#1111                                                                                                                                                                         
...
L_2_.KeyDown:Connect(
	...
	if L_22_arg0 == L_1_ then		if DaHoodSettings.SilentAim == true then
...
local L_6_ = L_5_:NewSection("counter.lua")
...
local L_10_ = L_9_:NewSection("15X")
